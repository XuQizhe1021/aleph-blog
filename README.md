...
你好，我是XuQizhe1021，我知道你会来看源仓库（https://github.com/XuQizhe1021/aleph-blog）。

如果你想使用的话，记得把我代码里的硬编码（例如站点标题、描述、部分链接等）替换为你自己的。
...
另外记得在关于里给我个友链O(∩_∩)O：（https://github.com/XuQizhe1021）。
